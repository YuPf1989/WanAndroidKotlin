 ...
 * Description:
 */
class SystemDetailListAdapter(layoutResId: Int, data: List<SystemDetailListBean.DatasBean>?) : BaseQuickAdapter<SystemDetailListBean.DatasBean, BaseViewHolder>(layoutResId, data) {
    override fun convert(helper: BaseViewHolder, item: SystemDetailListBean.DatasBean) {
